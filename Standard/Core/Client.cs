...
namespace RemoteCore
{
    public class Client : RemoteBase
    {
        ...
        public bool Reconnect(TimeSpan? timeout = null)
        {
            ...
            this.socket =
                WaitForServer(
                    ...
                    this.ConnectionChanged).Result.socket;
        ...
        public bool Send(object message) => base.Send(this.socket, message);

        /// <summary>
        /// Sends the raw.
        /// </summary>
        /// <param name="message">The message.</param>
        public bool SendRaw(params byte[] message) => base.SendRaw(this.socket, message);
        ...
        private void Initialize()
        {
            ...
            if (this.IsConnected)
            {
                // create the observeable to watch the Connection.
                Task.Run(() => this.SocketReader(this.socket));
            }
        }
