...
namespace RemoteCore
{
    ...
    public abstract class RemoteBase : IDisposable
    {
        ...
        /// </summary>
        public static readonly IRemoteObjectSerializer DefaultSerializer = new BinaryRemoteObjectSerializer();
        ...
        /// The serialization.
        /// </value>
        public IRemoteObjectSerializer Serialization { get; set; } = DefaultSerializer;
        ...
        /// <returns></returns>
        protected virtual async Task SocketReader(Socket socket, int rawBufferSize = RemoteConstants.RawBufferSize)
        {
        ...
        [Serializable]
        protected static class RemoteConstants
        {
            /// <summary>
            /// The default port
            /// </summary>
